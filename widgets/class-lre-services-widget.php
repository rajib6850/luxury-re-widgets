...
class LRE_Services_Widget extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->start_controls_tabs( 'tabs_service_items' );
			...
			$this->add_control( 'item_bg', array( 'label' => __( 'Background Color', 'luxury-re-widgets' ), 'type' => Controls_Manager::COLOR, 'selectors' => array( '{{WRAPPER}} .service-item' => 'background-color: {{VALUE}};' ) ) );
			...
			$this->add_control( 'item_bg_hover', array( 'label' => __( 'Hover Background', 'luxury-re-widgets' ), 'type' => Controls_Manager::COLOR, 'selectors' => array( '{{WRAPPER}} .service-item:hover' => 'background-color: {{VALUE}};' ) ) );
